package com.sapient.football.league.dto;

public class StandingLeagueResponseDTO {
	...
	public String toString() {
		return "LeagueResponseDTO [country_id=" + country_id + ", country_name=" + country_name + ", legaue_id="
				+ legaue_id + ", league_name=" + league_name + ", team_id=" + team_id + ", team_name=" + team_name
